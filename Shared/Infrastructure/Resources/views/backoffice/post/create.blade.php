    ...
    <div class="row justify-content-center">
        <div class="col-md-12 pb-5">
            <div class="card mb-5">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("backoffice.posts.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 mt-3">
                                ...
                                <div style="padding-bottom: 4px">
                                    <span class="btn btn-info btn-xs select-all btn-rounded" style="border-radius: 0">{{ trans('global.select_all') }}</span>
                                    <span class="btn btn-info btn-xs deselect-all btn-rounded" style="border-radius: 0">{{ trans('global.deselect_all') }}</span>
                                </div>
                            ...
                            <div class="form-group col-md-9 mt-3">
                                ...
                                <textarea class="form-control {{ $errors->has('excerpt') ? 'is-invalid' : '' }}" name="excerpt" id="excerpt" rows="4">{{ old('excerpt') }}</textarea>
